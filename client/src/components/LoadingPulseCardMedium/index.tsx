...
const LoadingPulseCardMedium: FC = () => {
  return (
    <div className="w-full h-40 flex flex-row justify-start items-start bg-white shadow-[0_0_10px_0px_rgba(0,0,0,0.08)] rounded-xl px-4 py-2 gap-3 animate-pulse">
