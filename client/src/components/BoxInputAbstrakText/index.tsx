...
const BoxInputAbstrakText: FC = () => {
  return (
    <div className="w-full flex flex-col justify-start items-start gap-1.5">
      ...
      {/* box input */}
      <div className="w-full flex flex-row justify-start items-center bg-gray-300/50 rounded-bl-full rounded-tr-full  transition-all ease-in-out duration-300 focus-within:shadow-[0px_2px_7px_0px_rgba(66,133,244,0.9)] shadow-[0px_2px_7px_0px_rgba(0,0,0,0.2)]">
        <input
          type="text"
